...
void FglTFRuntimeHttpProgress_DelegateWrapper(const FScriptDelegate& glTFRuntimeHttpProgress, FglTFRuntimeConfig const& LoaderConfig, int32 BytesProcessed, int32 TotalBytes)
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UglTFRuntimeFunctionLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromClipboard, "glTFLoadAssetFromClipboard" }, // 4272625540
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromData, "glTFLoadAssetFromData" }, // 346361041
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromFilename, "glTFLoadAssetFromFilename" }, // 567066608
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromFilenameAsync, "glTFLoadAssetFromFilenameAsync" }, // 948582453
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromString, "glTFLoadAssetFromString" }, // 3811276226
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromUrl, "glTFLoadAssetFromUrl" }, // 3946611021
		{ &Z_Construct_UFunction_UglTFRuntimeFunctionLibrary_glTFLoadAssetFromUrlWithProgress, "glTFLoadAssetFromUrlWithProgress" }, // 3045087914
	...
	struct Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_glTFRuntime_HostProject_Plugins_glTFRuntime_Source_glTFRuntime_Public_glTFRuntimeFunctionLibrary_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_glTFRuntime_HostProject_Plugins_glTFRuntime_Source_glTFRuntime_Public_glTFRuntimeFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UglTFRuntimeFunctionLibrary, UglTFRuntimeFunctionLibrary::StaticClass, TEXT("UglTFRuntimeFunctionLibrary"), &Z_Registration_Info_UClass_UglTFRuntimeFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UglTFRuntimeFunctionLibrary), 396091752U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_glTFRuntime_HostProject_Plugins_glTFRuntime_Source_glTFRuntime_Public_glTFRuntimeFunctionLibrary_h_2954999393(TEXT("/Script/glTFRuntime"),
		Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_glTFRuntime_HostProject_Plugins_glTFRuntime_Source_glTFRuntime_Public_glTFRuntimeFunctionLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_glTFRuntime_HostProject_Plugins_glTFRuntime_Source_glTFRuntime_Public_glTFRuntimeFunctionLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
