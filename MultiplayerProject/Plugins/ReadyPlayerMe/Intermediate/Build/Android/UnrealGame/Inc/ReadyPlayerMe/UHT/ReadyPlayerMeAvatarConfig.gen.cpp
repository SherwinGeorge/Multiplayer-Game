...
// Cross Module References
	...
	READYPLAYERME_API UEnum* Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod();
...
// End Cross Module References
	...
	static FEnumRegistrationInfo Z_Registration_Info_UEnum_EAvatarMeshLod;
	static UEnum* EAvatarMeshLod_StaticEnum()
	{
		if (!Z_Registration_Info_UEnum_EAvatarMeshLod.OuterSingleton)
		{
			Z_Registration_Info_UEnum_EAvatarMeshLod.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod, (UObject*)Z_Construct_UPackage__Script_ReadyPlayerMe(), TEXT("EAvatarMeshLod"));
		}
		return Z_Registration_Info_UEnum_EAvatarMeshLod.OuterSingleton;
	}
	template<> READYPLAYERME_API UEnum* StaticEnum<EAvatarMeshLod>()
	{
		return EAvatarMeshLod_StaticEnum();
	}
	struct Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::Enumerators[] = {
		{ "EAvatarMeshLod::High", (int64)EAvatarMeshLod::High },
		{ "EAvatarMeshLod::Medium", (int64)EAvatarMeshLod::Medium },
		{ "EAvatarMeshLod::Low", (int64)EAvatarMeshLod::Low },
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "High.DisplayName", "High (0)" },
		{ "High.Name", "EAvatarMeshLod::High" },
		{ "Low.DisplayName", "Low (2)" },
		{ "Low.Name", "EAvatarMeshLod::Low" },
		{ "Medium.DisplayName", "Medium (1)" },
		{ "Medium.Name", "EAvatarMeshLod::Medium" },
		{ "ModuleRelativePath", "Public/AvatarConfig/ReadyPlayerMeAvatarConfig.h" },
	};
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_ReadyPlayerMe,
		nullptr,
		"EAvatarMeshLod",
		"EAvatarMeshLod",
		Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod()
	{
		if (!Z_Registration_Info_UEnum_EAvatarMeshLod.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EAvatarMeshLod.InnerSingleton, Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_EAvatarMeshLod.InnerSingleton;
	}
...
#endif
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod_MetaData[] = {
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod = { "MeshLod", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UReadyPlayerMeAvatarConfig, MeshLod), Z_Construct_UEnum_ReadyPlayerMe_EAvatarMeshLod, METADATA_PARAMS(Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod_MetaData)) }; // 2371801921
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod_Underlying,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UReadyPlayerMeAvatarConfig_Statics::NewProp_MeshLod,
	...
	struct Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics::EnumInfo[] = {
		...
		{ EAvatarMeshLod_StaticEnum, TEXT("EAvatarMeshLod"), &Z_Registration_Info_UEnum_EAvatarMeshLod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2371801921U) },
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UReadyPlayerMeAvatarConfig, UReadyPlayerMeAvatarConfig::StaticClass, TEXT("UReadyPlayerMeAvatarConfig"), &Z_Registration_Info_UClass_UReadyPlayerMeAvatarConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UReadyPlayerMeAvatarConfig), 1329164273U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_1893256277(TEXT("/Script/ReadyPlayerMe"),
		Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_AvatarConfig_ReadyPlayerMeAvatarConfig_h_Statics::EnumInfo));
