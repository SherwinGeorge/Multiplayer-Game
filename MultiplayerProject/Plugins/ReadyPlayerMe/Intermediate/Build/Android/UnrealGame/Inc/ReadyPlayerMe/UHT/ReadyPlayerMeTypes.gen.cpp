...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FAvatarMetadata_Statics::NewProp_OutfitVersion = { "OutfitVersion", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FAvatarMetadata, OutfitVersion), METADATA_PARAMS(Z_Construct_UScriptStruct_FAvatarMetadata_Statics::NewProp_OutfitVersion_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAvatarMetadata_Statics::NewProp_OutfitVersion_MetaData)) };
#if WITH_METADATA
...
void FDownloadImageCompleted_DelegateWrapper(const FScriptDelegate& DownloadImageCompleted, UTexture2D* Texture)
{
	struct _Script_ReadyPlayerMe_eventDownloadImageCompleted_Parms
	{
		UTexture2D* Texture;
...
void FAvatarPreloadCompleted_DelegateWrapper(const FScriptDelegate& AvatarPreloadCompleted, bool bSuccess)
{
	struct _Script_ReadyPlayerMe_eventAvatarPreloadCompleted_Parms
	{
		bool bSuccess;
	...
	static UEnum* ERenderSceneType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ERenderSceneType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_ReadyPlayerMe_ERenderSceneType, (UObject*)Z_Construct_UPackage__Script_ReadyPlayerMe(), TEXT("ERenderSceneType"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics::ScriptStructInfo[] = {
		{ FAvatarMetadata::StaticStruct, Z_Construct_UScriptStruct_FAvatarMetadata_Statics::NewStructOps, TEXT("AvatarMetadata"), &Z_Registration_Info_UScriptStruct_AvatarMetadata, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAvatarMetadata), 2445007708U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_3553061754(TEXT("/Script/ReadyPlayerMe"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Runners_Unreal__work_Unreal_SDK_Unreal_SDK_Archive_Plugins_ReadyPlayerMe_HostProject_Plugins_ReadyPlayerMe_Source_ReadyPlayerMe_Public_ReadyPlayerMeTypes_h_Statics::EnumInfo));
